...
namespace RTypeClient {
    class RFCClientGameHandler : public RTypeProtocol::IRFCHandler
    {
        ...
        std::map<int, UgandaEngine::Entity *> &_entity;
        std::shared_ptr<UgandaEngine::AGameEngine> &_engine;

    public:
        RFCClientGameHandler(std::shared_ptr<IClientUdpSocket> &socket, std::map<int, UgandaEngine::Entity *> &ent, std::shared_ptr<UgandaEngine::AGameEngine> &eng);
